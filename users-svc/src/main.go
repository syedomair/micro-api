...
func AuthInterceptor(ctx context.Context, req interface{}, info *grpc.UnaryServerInfo, handler grpc.UnaryHandler) (interface{}, error) {
	...
	if !ok {
		return &pb.ResponseList{Result: common.FAILURE, Error: common.ErrorMessage("4001", "Missing context metadata."), Data: nil}, nil
	}
	if len(meta["authorization"]) != 1 {
		return &pb.ResponseList{Result: common.FAILURE, Error: common.ErrorMessage("4002", "Missing authorization token."), Data: nil}, nil
	}
	currentUserId, clientId, authErr := common.CheckAuth(meta["authorization"][0])
	if authErr != nil {
		return &pb.ResponseList{Result: common.FAILURE, Error: common.JWTError(authErr.Error()), Data: nil}, nil
	}
